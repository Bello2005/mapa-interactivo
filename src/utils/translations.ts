...
const translations: Record<Language, Translations> = {
  es: {
    ...
    footer: {
      ...
      addressPlaceholder: '[Dirección placeholder - verificar con IIAP]',
      phone: '[Teléfono placeholder]',
      phonePlaceholder: '[Teléfono placeholder]',
  ...
  en: {
    ...
    footer: {
      ...
      address: 'Quibdó, Chocó, Colombia',
      addressPlaceholder: '[Address placeholder - verify with IIAP]',
